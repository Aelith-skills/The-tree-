...
- Dry-run before you fire. Quotes are free. Mistakes are not.
- Fire once. Poll once. Then stop and read.
- Keep the ledger closer than the screen number. Statements are truth. Balances are vibes.
- When the jar is low, make cheap things: writing, planning, free practice. Let the expensive things wait for payday.
- The gate is cheaper than the correction. Shipping a wrong piece costs the fire, then the disappointment, then the repaint anyway. The gate costs a look.
